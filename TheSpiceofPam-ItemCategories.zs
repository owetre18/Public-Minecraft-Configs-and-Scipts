...
# Vegetable
var vegetable = <ore:listAllveggie>;
...
sandwich.add(<harvestcraft:beetburgerItem>);
sandwich.add(<harvestcraft:mcpamItem>);
sandwich.add(<harvestcraft:bltItem>);
sandwich.add(<harvestcraft:bbqpulledporkItem>);
sandwich.add(<harvestcraft:grilledcheeseItem>);
sandwich.add(<harvestcraft:hamburgerItem>);
sandwich.add(<harvestcraft:toastsandwichItem>);
sandwich.add(<harvestcraft:chickensandwichItem>);
sandwich.add(<harvestcraft:fishsandwichItem>);
sandwich.add(<harvestcraft:leafychickensandwichItem>);
sandwich.add(<harvestcraft:leafyfishsandwichItem>);
...
sandwich.add(<harvestcraft:gooseberryjellysandwichItem>);
sandwich.add(<harvestcraft:hamsweetpicklesandwichItem>);
sandwich.add(<harvestcraft:pearjellysandwichItem>);
sandwich.add(<harvestcraft:plumjellysandwichItem>);
sandwich.add(<harvestcraft:honeysandwichItem>);
sandwich.add(<harvestcraft:footlongItem>);
sandwich.add(<harvestcraft:pbandjItem>);
sandwich.add(<harvestcraft:sausageinbreadItem>);
sandwich.add(<harvestcraft:hotdogItem>);
sandwich.add(<harvestcraft:cheeseburgerItem>);
sandwich.add(<harvestcraft:baconcheeseburgerItem>);
sandwich.add(<harvestcraft:deluxecheeseburgerItem>);
sandwich.add(<harvestcraft:baconmushroomburgerItem>);
sandwich.add(<harvestcraft:onionhamburgerItem>);
sandwich.add(<harvestcraft:coleslawburgerItem>);
sandwich.add(<harvestcraft:beansontoastItem>);
sandwich.add(<harvestcraft:vegemiteontoastItem>);
sandwich.add(<harvestcraft:cheeseontoastItem>);

# Bread
var bread       =<ore:foodBread>;

bread.add(<harvestcraft:pumpkinbreadItem>);
bread.add(<harvestcraft:cornbreadItem>);
bread.add(<harvestcraft:gingerbreadItem>);
bread.add(<harvestcraft:garlicbreadItem>);
bread.add(<harvestcraft:zucchinibreadItem>);
bread.add(<harvestcraft:walnutraisinbreadItem>);
bread.add(<harvestcraft:banananutbreadItem>);
bread.add(<harvestcraft:datenutbreadItem>);
bread.add(<harvestcraft:fairybreadItem>);